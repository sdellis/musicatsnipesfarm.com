...
export default {
  metaInfo: {
    title: 'Music at Snipes Farm | Morrisville, PA',
    meta: [
      {
        description: 'Music at Snipes Farm hosts music festivals that brings the best of local talent to a beautiful outdoor landscape with state of the art stage production. Most festivals showcase musicians who play in the tradition of Blues, Jazz, Folk, and Classic Jam Rock such as The Allman Brothers and The Greatful Dead.',
      }
    ],
  }
}
